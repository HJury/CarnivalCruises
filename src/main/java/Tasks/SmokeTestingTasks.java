...
import pageObjects.CruiseInformationPage;
...
public class SmokeTestingTasks {
    ...
    public SmokeTestingTasks(WebDriver driver) {
        ...
        cruiseInformationPage = new CruiseInformationPage(driver);
    }
    ...
    public void waitForBanner() {
        cruiseInformationPage.waitForElement(roadMap);
    }
    ...
    public void theInformationIsDisplayed() {
        cruiseInformationPage.theInformationIsDisplayed();
    }
    ...
    public void theElementIsDisplayed(String button) {
        cruiseInformationPage.theElementIsDisplayed(button);
    }
}
